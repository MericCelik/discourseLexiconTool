...
public class calculateInterAgreement {
    ...
    public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException, ParserConfigurationException {
        calculateInterAgreement calculator = new calculateInterAgreement("Agreement\\old\\tuğçe", "Agreement\\old\\murathan", "IMPLICIT"); // 85,  123
        calculateInterAgreement calculator2 = new calculateInterAgreement("Agreement\\old\\savas", "Agreement\\old\\serkan", "IMPLICIT"); // 85,  123
